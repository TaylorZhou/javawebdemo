...
public class DateUtil {
    ...
    public static Date parseDate(String dateStr, String dateFormat) {
        ...
        try {
            ...
            if (maxLen != 0) {
                dateStr = org.apache.commons.lang3.StringUtils.substring(dateStr, 0, maxLen);
            }

            return df.parse(dateStr);
        } catch (Exception ex) {
            throw new RuntimeException("can not parse to date", ex);
        }
    }
    ...
    public static void main(String[] args) {
        System.out.println(DateUtil.transferLongToDate(YYYY_MM_DD_HH24MISS,1518076093212l));
    }
